...
@proxylist = ['http://146.166.45.16:8080','http://146.166.45.16:8080']
...
@zipcodes.each do |zip|
  ...
  while $k < 1 do
    ...
    url = "https://www.gofundme.com/Medical-Illness-Healing?age=#{$k+1}&term=#{$zip}"
    ...
    while $i < 10 do
      ...
      res_money = res_money.tr(',','')
      money = Integer(res_money)
