  ...
  def scrape zip, proxy
    ...
    while $k < 50 do
      ...
      while $i < 10 do
        ...
        File.open('../workers/dump/worker3/logs.txt', 'w') { |file| file.write(log) }
        puts 'LOGGED'
...
proxylist = ["http://45.55.229.152:8888"]
@proxy = proxylist[0]
$scrape = Scrape.new
...
zipcodes.reverse_each do |zip|
  $zip = zip
  @continue = true if zip == '88901' # Enter worker start
