  ...
  def scrape zip, proxy
    ...
    while $k < 50 do
      ...
      while $i < 10 do
        ...
        res_location = res_location.split(', ')
        city = res_location[0]
        ...
        log = "LAST COMPLETION: Time #{time} || Zipcode #{$zip} || Page #{$k+1} || Campaign #{link}"
...
#///////////////////////////////////////////////////////////////////////////////
@proxylist = ["http://104.207.159.54:3128","http://177.20.208.178:8080","http://180.180.109.147:8080","http://208.111.7.125:8081","http://190.189.237.106:8080","http://83.221.208.217:8080","http://187.17.16.44:3128","http://223.164.250.250:8080","http://120.29.159.146:8080","http://202.152.40.28:8080"]
